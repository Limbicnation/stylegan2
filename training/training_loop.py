...
def training_loop(
    ...
    #resume_pkl              = './ML-Images/stylegan2/results/00004-stylegan2-covidfaces1024-1gpu-config-f/network-snapshot-000540.pkl',     # Network pickle to resume training from, None = train from scratch.
    #resume_pkl              = None,
    resume_pkl              = 'latest',
